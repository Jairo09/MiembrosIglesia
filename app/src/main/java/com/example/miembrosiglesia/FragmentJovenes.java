...
public class FragmentJovenes extends Fragment{
    View v;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.jovenes_fragment, container, false);

        myrecyclerview = v.findViewById(R.id.jovenesReciclerview);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i < miembrosList.size(); i++) {
            ...
            if (miembrosList.get(i).getSociedad().equals("Jóvenes")) {
