...
public class FragmentSenioras extends Fragment{
    View v;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.senioras_fragment, container, false);

        myrecyclerview = v.findViewById(R.id.seniorasReciclerview);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i < miembrosList.size(); i++) {
            ...
            if (miembrosList.get(i).getSociedad().equals("Señoras")) {
